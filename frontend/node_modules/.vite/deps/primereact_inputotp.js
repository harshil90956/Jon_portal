...
var InputOtp = import_react3.default.memo(import_react3.default.forwardRef(function(inProps, ref) {
  var _props$value, _props$value$split;
  var elementRef = (0, import_react3.useRef)(ref);
  var mergeProps2 = useMergeProps();
  var context = (0, import_react3.useContext)(PrimeReactContext);
  var props = InputOtpBase.getProps(inProps, context);
  var _InputOtpBase$setMeta = InputOtpBase.setMetaData(_objectSpread5(_objectSpread5({
    props
  }, props.__parentMetadata), {}, {
    context: {
      disabled: props.disabled
  ...
  var _useState = (0, import_react3.useState)(defaultValue), _useState2 = _slicedToArray5(_useState, 2), tokens = _useState2[0], setTokens = _useState2[1];
  ...
  var updateTokens = function updateTokens2(event, index) {
    ...
    var newTokens = _toConsumableArray6(tokens);
    ...
    switch (event.code) {
      ...
      case "Delete": {
        ...
        if (!Number.isNaN(idx) && !isAllEmpty(tokens, props.length)) {
          updateTokens(_objectSpread5(_objectSpread5({}, event), {}, {
  ...
  var _createInputElements = function createInputElements(remainingInputs) {
    ...
    }) : import_react3.default.createElement(InputText, _extends4({}, inputElementProps, inputElementEvents, {
      key: inputElementIndex
    }));
    var inputElements = [inputElement].concat(_toConsumableArray6(_createInputElements(remainingInputs - 1)));
  ...
  return import_react3.default.createElement("div", rootElementProps, _createInputElements(props.length));
}));
